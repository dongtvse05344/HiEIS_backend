...
namespace HiEIS.Data
{
    public class HiEISDbContext : IdentityDbContext<MyUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Company>().HasMany(_ => _.Transactions).WithOne(_ => _.Company);
            builder.Entity<Company>().HasMany(_ => _.CompanyCustomers).WithOne(_ => _.Company);
            #endregion
            ...
            #region MyUser
            builder.Entity<MyUser>().Property(_ => _.Name).HasMaxLength(100).IsRequired().IsUnicode();
